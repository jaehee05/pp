  ...
  },
  {
    ...
    body: (
      <>
        ...
        <H>시즌 제한 (월별 노출)</H>
        <p>이용권 폼의 "노출 월" 카드 — 1~12월 체크박스로 어느 달에 판매할지 지정. 프리셋:
        <b>전체 토글</b> (선택↔해제) / <b>여름방학 (7,8월)</b> / <b>겨울방학 (12,1,2월)</b> / <b>학기 (방학 제외)</b>.</p>
        <p><b>판정 기준 = 이용권 시작 예정월</b>. 구매일이 아니라 이 학생이 이 이용권을 사면 시작될 날의 월로 필터.
          예: 6월에 결제하지만 기존 이용권이 6/30 만료라면 시작은 7/1 → 7월권만 노출.
          신규 학생이라면 오늘 기준.</p>
        <p>예시 셋업:</p>
        <ul className="ml-5 list-disc">
          <li>"여름방학 이용권" → [여름방학] 프리셋 → 7,8월 시작 예정일 때만 노출</li>
          <li>"일반 정기권" → [학기] 프리셋 → 7,8월엔 자동 숨김</li>
        </ul>
        <H>갱신 결제 (큐잉)</H>
