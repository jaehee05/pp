...
const SECTIONS: Section[] = [
  {
    ...
    body: (
      <>
        ...
        <Step n={2} t="이용권 등록">
          [관리 → 좌석 이용권 관리] → "+ 이용권 추가" → 이름·기간·메인/서브 금액 등 설정.
        </Step>
        <Step n={3} t="좌석 배치">
        ...
        <Step n={4} t="회원 등록">
          [운영 → 회원등록] → 성함·성별·연락처·PIN(4자리)·생년월일·보호자 정보 입력 → 등록.
        </Step>
        <Step n={5} t="좌석 배정 + 결제">
    ...
    body: (
      <>
        ...
        <ul className="ml-5 list-disc">
          ...
          <li><b>지역상품권 QR</b>: 메인/서브 가맹점별 결제 대기 등록 → 학생이 지역상품권 앱으로 QR 결제 → 운영자가 수동 [✓ 결제 완료 처리] → 양쪽 완료 시 이용권 자동 활성화</li>
    ...
    body: (
      <>
        ...
        <Q q="이용권 선택 화면에 일부가 안 보임">
          이용권이 "숨김" 상태. 이용권 선택 박스 옆 [숨긴 이용권 보기] 체크.
        </Q>
        <Q q="Bridge 앱이 안 떠짐">
